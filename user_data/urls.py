...
from .views import UserProfileViewSet, MyFavoritePropertyViewsSet,MybookingInforsViewSet, MyBookingBankPaymentDetailsViewSet,MyMobileMoneyPaymentinfosViewSet, MyAddressViewSet
