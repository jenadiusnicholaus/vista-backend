...
from . models import  (Property, PropertyAmenity,PropertyFacility , PropertyImages, PropertyOwner, Category, PropertyReview)  
# Register your models here.

class PropertyAdmin(admin.ModelAdmin):
    list_display = [ 'name', 'category', 'price',  'address', 'city', 'state', 'country', 'latitude', 'longitude','owner', 'image', 'availability_status', 'publication_status', 'created_at', 'updated_at']
    search_fields = [ 'name', 'category', 'price',  'address', 'city', 'state', 'country', 'latitude', 'longitude','owner', 'image', 'availability_status', 'publication_status', 'created_at', 'updated_at']
    list_filter = [ 'name', 'category', 'price',  'address', 'city', 'state', 'country', 'latitude', 'longitude','owner', 'image', 'availability_status', 'publication_status', 'created_at', 'updated_at']
    list_per_page = 10
